...
try:
    ...
    raise FileNotFoundError(f"{classes_file} not found in backend directory")
except Exception as e:
    raise ValueError(f"Error reading classes.txt: {str(e)}")
...
model_path = Path(__file__).parent.parent / "all_crops_hybrid_best_model.pth"
try:
...
def predict_disease(file):
    ...
    try:
        img_bytes = file.read()  # Read file content
